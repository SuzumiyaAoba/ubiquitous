...
import type { BoundedContext, CreateContextDto, UpdateContextDto } from "@ubiquitous/types";
...
export const contextsApi = {
   ...
   * コンテキストを作成
   */
  create: (data: CreateContextDto) => apiClient.post<BoundedContext>("/api/contexts", data),
