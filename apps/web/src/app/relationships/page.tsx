...
import { TermRelationship, Term, CreateRelationshipDto } from '@ubiquitous/types';
import { relationshipsApi, termsApi } from '@/shared/api';
import { Button, Card, CardHeader, CardTitle, CardContent, Loading, Select, Textarea, Modal, Table, TableHeader, TableBody, TableRow, TableHead, TableCell } from '@/shared/ui';
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4">
            <Select
              ...
              onChange={(value) => setFormData({ ...formData, sourceTermId: value })}
            ...
            <Select
              ...
              onChange={(value) =>
                setFormData({
                  ...formData,
                  relationshipType: value as CreateRelationshipDto['relationshipType'],
                })
              }
              options={[
            ...
            <Select
              ...
              onChange={(value) => setFormData({ ...formData, targetTermId: value })}
              options={terms.map(term => ({ value: term.id, label: term.name }))}
              placeholder="用語を選択"
