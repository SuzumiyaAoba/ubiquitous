        ...
        <Card>
          <CardContent>
            <p className="text-gray-500 text-center py-8">
              {searchQuery ? "検索結果がありません" : "用語がまだ登録されていません。"}
            </p>
          </CardContent>
        </Card>
      ) : (
              ...
              <TableBody>
                {terms.map((term) => (
                  <TableRow key={term.id}>
                    ...
                    <TableCell>
                      <p className="line-clamp-2 text-gray-600">{term.definition || "定義なし"}</p>
                    </TableCell>
                    <TableCell>
                      <span
                    ...
                    <TableCell>
                      {term.createdAt ? new Date(term.createdAt).toLocaleDateString("ja-JP") : "-"}
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
