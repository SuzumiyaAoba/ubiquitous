...
import { BoundedContext, CreateTermDto } from '@ubiquitous/types';
  ...
  useEffect(() => {
    const fetchContexts = async () => {
      try {
        ...
        setError(err instanceof Error ? err.message : 'コンテキストの取得に失敗しました');
      } finally {
        setLoading(false);
      }
    };
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <Select
                ...
                onChange={(value) => setFormData({ ...formData, boundedContextId: value })}
