...
import { BoundedContext, UpdateContextDto } from '@ubiquitous/types';
import { contextsApi } from '@/shared/api';
import { Button, Card, CardHeader, CardTitle, CardContent, Input, Textarea, Loading } from '@/shared/ui';

export default function EditContextPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      <div className="mb-6">
        <Link href={`/contexts/${params.id}`} className="text-blue-600 hover:text-blue-800 text-sm">
          ← 詳細に戻る
        </Link>
      </div>
