...
export const proposalStatusEnum = ['pending', 'approved', 'rejected', 'on_hold'] as const;
...
export const termProposals = pgTable('term_proposals', {
  ...
  boundedContextIdx: index('idx_term_proposals_bounded_context').on(table.boundedContextId),
